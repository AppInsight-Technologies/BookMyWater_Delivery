...
import 'package:hollisticdelivery/providers/cashlogfields.dart';
import 'package:hollisticdelivery/providers/group_order_provider.dart';
...
*/
  ...
  debugPrint("jhgfghj..."+id);
    ...
    print("get drop type Url......"+url.toString()+{
      "id": id
    }.toString());
    final responseJson = json.decode(utf8.decode(response.bodyBytes));
    debugPrint("jhgfghj.....1.."+responseJson.toString());
    if (responseJson.toString() != "[]") {
...
*/
 ...
 List<OrdersFields>get recentitems{
  ...
  Future<void> fetchNotificationLogs(String userId) async {
    // imp feature in adding async is the it automatically wrap into Future.
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var url = IConstants.API_PATH + 'get-notification/$userId/'+'77'
