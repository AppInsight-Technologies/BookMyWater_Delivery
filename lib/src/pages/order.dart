...
import 'package:hollisticdelivery/constants/Iconstants.dart';
import 'package:hollisticdelivery/providers/bottles.dart';
import 'package:hollisticdelivery/utils/prefUtils.dart';
     ...
     await Provider.of<OrdersItemsList>(context,listen:false).Login();
      ...
      Provider.of<OrdersItemsList>(context,listen:false).GetItems(_orderid).then((
        ...
        setState(() {
          ...
          totalBottlesCount = ordersData.orderitems[0].totalBottles;
                                      ...
                                      SizedBox(
                                        ...
                                        child: FlatButton(
                                          ...
                                          arguments: new RouteArgument(param: _address));*/
                                            print("Map......"+_latitude.toString()+_longitude.toString());
                            ...
                            itemBuilder: (context, index) {
                              return OrderItemWidget(
                                 imageurl: ordersData.orderitems[index].imageurl,
                                  ...
                                  SecurityCode: ordersData.orderitems[index].SecurityCode,
                                  //order: _con.order,
                                  );
                            },
                          ),
...
//                                                        _con.doDeliveredOrder(_con.order);
                         ...
                         // totalBottleCount == '0' ? SizedBox.shrink() :
                               Padding(
                              padding: EdgeInsets.only(bottom: 10,left: 20,right: 20),
                              child: ElevatedButton(style: ButtonStyle().copyWith(backgroundColor:  MaterialStateProperty.all<Color>(config.Colors().blockSelectionColor) ) , onPressed: (){
                                ...
                                showModalBottomSheet(
                                 // useRootNavigator: true,
                                  ...
                                  return SingleChildScrollView(child: Padding(
                                    ...
                                    child: PickUpBottles(totalBottlesCount: (int.parse(totalBottlesCount) - increaseBottleCount).toString(), customerNo: _customerNo, addedBottles: (int addBottles){
                                      setState(() {
                                        increaseBottleCount = addBottles;
                                      });
                              ...
                              }, child: Row(children: [Text('Bottle with Customer', style: TextStyle(color: Theme.of(context).accentColor, fontWeight: FontWeight.bold),), Spacer(),Text((int.parse(totalBottlesCount) - increaseBottleCount).toString(), style: TextStyle(color: Theme.of(context).accentColor)),Icon(Icons.arrow_forward_ios, color: Theme.of(context).accentColor, size: 16,)],)))
                        ],
                      ),
                    ),
                  ),
...
class PickUpBottles extends StatefulWidget {
  PickUpBottles({Key key, this.customerNo, this.totalBottlesCount, this.addedBottles}) : super(key: key);
...
class _PickUpBottlesState extends State<PickUpBottles> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [Text('Pickup Bottles', style: TextStyle(fontSize: 18, color: Theme.of(context).accentColor, fontWeight: FontWeight.bold),), Row(
      children: [
        ...
        Container(
          ...
          color: config.Colors().blockSelectionColor,
            padding: EdgeInsets.only(top:8, bottom: 8, left: 32, right: 32),
            child: Text(widget.totalBottlesCount))
      ],
    ),
    SizedBox(height: 10),
    Row(children: [Text('Bottles Collected'), Spacer(),
      Container(
          width: 100,
          height: 36,
          child: TextField(
          ...
          Container(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom().copyWith(backgroundColor: MaterialStateProperty.all<Color>(Theme.of(context).accentColor)),
