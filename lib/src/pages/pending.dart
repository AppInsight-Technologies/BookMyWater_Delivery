...
import 'package:hollisticdelivery/constants/images.dart';
import 'package:hollisticdelivery/generated/i18n.dart';
import 'package:hollisticdelivery/providers/group_provider.dart';
import 'package:hollisticdelivery/providers/ordersitems.dart';
import 'package:hollisticdelivery/src/models/route_argument.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
       // title: SvgPicture.asset("assets/img/Logo.png", width: 40, height: 45,color: Colors.white,),/*Text(
